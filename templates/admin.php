<div class="wrap">
	...
	<div class="tab-content">
		...
		<div id="tab-2" class="tab-pane">
			...
			<br>
			<p><?php echo __('Current version', 'v2rayq-lite')?>: 1.0.0</p>
			<p><?php echo __('Support', 'v2rayq-lite')?>: <a href="https://www.v2rayq.com/docs/lite"> https://www.v2rayq.com/docs/lite</a></p>
		</div>
	</div>
</div>